# CLAUDE.md — ai-blog-assistant 项目规范
> 中间层约束文档（项目级）
> 继承自：~/.claude/rules/common/ 全局规范
...
**技术栈**：Next.js 14 + TailwindCSS + Shadcn/UI + Anthropic Claude API + Supabase + Clerk + Vercel
...
**阶段**：P0 项目初始化
**下一步**：技术框架搭建（Next.js 初始化 → Claude API 接入 → 核心编辑器）
